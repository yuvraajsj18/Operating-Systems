/*
    Question 4 from first file
    Yuvraj Singh Jadon
    194076
    BSc (h) CS, OS

    WAP to implement FCFS scheduling algo. Implement for 5 processes. Print the
    turn around time and waiting time for each process. Print average turn around time
    and average waiting time too.
*/
