/*
    Question 1 from first file
    Yuvraj Singh Jadon
    194076
    BSc (h) CS, OS

    WAP to implement First fit allocation strategy. Take size of 5 memory holes
    initially. Then take size of 5 processes. As output specify which process fits in while
    memory hole.
*/
